          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
                Operativo sul territorio a Biella e nei comuni limitrofi per interventi fisici sull&apos;hardware o sulla rete locale.
              </p>

              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                {[
                  "Assistenza PC a domicilio",
                  "Configurazione Wi-Fi e reti",
                  "Configurazione dispositivi",
                  "Supporto tecnico locale",
                  "Interventi che richiedono presenza sul posto"
                ].map((item, index) => (
...
17z"/>
                  ...
                  {/* La sagoma dell'Italia è una maschera: nodi e linee non possono uscire in mare. */}
